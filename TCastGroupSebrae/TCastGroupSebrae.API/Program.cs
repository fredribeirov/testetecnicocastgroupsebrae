...
builder.Services.AddDbContext<TCastGroupSebraeAPIContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("TCastGroupSebraeAPIContext") ?? throw new InvalidOperationException("Connection string 'TCastGroupSebraeAPIContext' not found.")));
